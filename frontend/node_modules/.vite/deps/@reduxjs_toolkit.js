...
var __publicField = (obj, key, value) => __defNormalProp3(obj, typeof key !== "symbol" ? key + "" : key, value);
    ...
    updates.forEach((update) => {
      ...
      if (update.id in state.entities) {
        updatesPerEntity[update.id] = {
          id: update.id,
          changes: __spreadValues3(__spreadValues3({}, (_a = updatesPerEntity[update.id]) == null ? void 0 : _a.changes), update.changes)
        };
      }
    });
